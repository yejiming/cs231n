try:
    from assignment2.cs231n.im2col_cython import col2im_cython, im2col_cython
    from assignment2.cs231n.im2col_cython import col2im_6d_cython
except ImportError:
    print("run the following from the cs231n directory and try again:")
    print("python setup.py build_ext --inplace")
    print("You may also need to restart your iPython kernel")

from assignment2.cs231n.im2col import *
