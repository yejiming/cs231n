...
from assignment3.cs231n import optim
from assignment3.cs231n.coco_utils import sample_coco_minibatch, decode_captions
...
class CaptioningSolver(object):
    ...
    def check_bleu(self):
        ...
        return total_score / len(sample_captions)
    ...
    def train(self):
        ...
        for t in range(num_iterations):
            ...
            if t == 0 or epoch_end or t == num_iterations - 1:
                bleu = self.check_bleu()
                print("(Epoch %d / %d) BLEU: %f" % (self.epoch, self.num_epochs, bleu))
